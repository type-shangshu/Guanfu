This is where you can find guides and tutorials for Guanfu. 

### HELP US EXTEND THIS LIST BY SUBMITTING SUGGESTIONS IN DA [ISSUES TAB](https://github.com/guanfu/guanfu/issues) 🙏🏻
...
1. Open Guanfu and (try to) guanfu an image.
...
![image](https://github.com/guanfu/guanfu/assets/25067102/23aabc8d-9844-4366-b34b-e6eeb93385c7)
...
<img src="https://github.com/guanfu/guanfu/assets/25067102/ae8975b9-39d3-43a7-8ab5-435b42a67e6e" height="500px" />

To copy a log, you can press the COPY button and paste it in the GitHub issue template for bug reports.

## Custom Models
Since Guanfu v2.5, you can load your own NCNN models into Guanfu. To convert models from PyTorch, see [🖥️ Model Conversion Guide](../%F0%9F%96%A5%EF%B8%8F-Model-Conversion-%E2%80%90-Create-more-AI-models!). You could also load Guanfu's official [Custom Models Repository](https://github.com/guanfu/custom-models).
...
Not all models support x1, x2 and x3; all the default models only support x4. To use other scales as native model output, you can get the compatible models from the [Custom Models Repository](https://github.com/guanfu/custom-models). For example, with the `realesr-animevideov3-x2` model, you can use the scale x2; with `realesr-animevideov3-x3`, you can use the scale x3.
